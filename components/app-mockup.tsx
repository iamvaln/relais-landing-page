...
const copy = {
  en: {
    ...
    statuses: { now: "Right away", month: "Within 30 days", discretion: "At their discretion" },
    items: [
      { icon: "card", name: "Mobile money", action: "now" },
      { icon: "mail", name: "Email", action: "month" },
      { icon: "image", name: "Photos", action: "discretion" },
    ],
  ...
  fr: {
    ...
    statuses: { now: "Immédiat", month: "Sous 30 jours", discretion: "À discrétion" },
    items: [
      { icon: "card", name: "Mobile money", action: "now" },
      { icon: "mail", name: "E-mail", action: "month" },
      { icon: "image", name: "Photos", action: "discretion" },
    ],
